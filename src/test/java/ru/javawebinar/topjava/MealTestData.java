...
public class MealTestData {
    ...
    private static User user = new User(USER_ID, "User", "user@yandex.ru", "password", Role.USER);
    ...
    public static Meal withUser(){
        Meal meal = new Meal(meal1.id(), meal1.getDateTime(), meal1.getDescription(), meal1.getCalories());
        meal.setUser(user);
        return meal;
    }
}
